...
<%--</script>--%>
<script src="<%=request.getContextPath()%>/assets/project/admin/history/list.js"></script>
    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="javascript:void(0)">Lịch sử hệ thống</a></li>
            </ul>
            <div class="m-b-md">
                        ...
                        <tr ng-repeat="item in page.items track by $index">
                            ...
                            <td class="align-center">
                                <a href="<%=request.getContextPath()%>/admin/system/history/{{item[1]}}">
                                    <i class="fa fa-history fa-2x" aria-hidden="true"  title="Xem log người dùng"></i>
                                </a>
