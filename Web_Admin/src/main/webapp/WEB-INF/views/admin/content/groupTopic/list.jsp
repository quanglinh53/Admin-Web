...
<script src="<%=request.getContextPath()%>/assets/project/admin/content/groupTopic/list.js"></script>
<script  type="text/javascript">
    $("#sansim-status").show();
    setTimeout(function() { $("#sansim-status").hide(); }, 5000);
</script>
<section id="content" ng-app="sansimso"  ng-controller="groupTopicCtrl">
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="#">Quản lý nhóm chủ đề</a></li>
                ...
                <div class="text-sm wrapper bg-light lt">
                    <form cssClass="form-inline padder" action="list" role="form" theme="simple">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="col-sm-4 control-label" style="text-align: end;">Tên nhóm chủ đề</label>
                                <div class="col-sm-8">
                                    <input ng-model="groupName" name="groupName" placeholder="" maxlength="50" my-enter="search()"  class="input-sm form-control"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <a ng-click="search()" class="btn btn-info btn-sm ">Tìm kiếm</a>
                                <sec:authorize access="hasRole('ROLE_CONTENT_GROUP_TOPIC_ADD')">
                                    <a class="btn btn-sm btn-primary <%--pull-right--%>"
                                       href="<%=request.getContextPath()%>/admin/content/group-topic/add"><i class="fa fa-plus"></i> Thêm mới</a>
                                </sec:authorize>
                                <%-- <div class="col-sm-8">
                    ...
                    <table id="tbl" class="table table-striped table-bordered m-b-none text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="box-shadow-inner small_col text-center">Tên nhóm chủ đề</th>
                                <th class="box-shadow-inner small_col text-center">Mô tả</th>
                                <sec:authorize access="hasAnyRole('ROLE_CONTENT_GROUP_TOPIC_EDIT','ROLE_CONTENT_GROUP_TOPIC_DELETE')">
                            ...
                            <tr ng-repeat="item in page.items track by $index">
                                ...
                                <sec:authorize access="hasAnyRole('ROLE_CONTENT_GROUP_TOPIC_EDIT','ROLE_CONTENT_GROUP_TOPIC_DELETE')">
                                    <td class="align-center">
                                        <sec:authorize access="hasAnyRole('ROLE_CONTENT_GROUP_TOPIC_EDIT')">
                                            <a href="<%=request.getContextPath()%>/admin/content/group-topic/edit/{{item.id}}">
                                                <img class="icon_action_in_list" src="<%=request.getContextPath()%>/assets/note/images/edit.jpg" title="Chỉnh sửa">
                                            </a>
                                        </sec:authorize>
                                        <sec:authorize access="hasAnyRole('ROLE_CONTENT_GROUP_TOPIC_DELETE')">
            ...
            <div class="modal-dialog" style="max-width: 500px;">
                <div class="modal-content"style="max-width: 500px;">
                    <div class="modal-header" style="padding: 7px;">
                        ...
                        <h5 class="modal-title" id="myModalLable">Xóa nhóm chủ đề</h5>
                    </div>
                    <form id="filter" method="POST"  action="<%=request.getContextPath()%>/admin/content/group-topic/delete" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        <div class="modal-body"  style="padding: 10px;">
                            <div class="form-group">
                                <label class="control-label">Bạn xác nhận xóa nhóm chủ đề này?</label>
