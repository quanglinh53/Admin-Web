...
<script src="<%=request.getContextPath()%>/assets/project/admin/mangement/transactionForm/list.js"></script>
...
<section id="content" ng-app="sansimso" ng-controller="transactionFormCtrl">
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                <li><a href="<%=request.getContextPath()%>/admin"><i class="fa fa-home"></i>&nbsp;Trang
                    chủ</a></li>
                <li><a href="#">Hình thức giao dịch</a></li>
                ...
                <div class="text-sm wrapper bg-light lt">
                    <form cssClass="form-inline padder" action="list" role="form" theme="simple">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label class="col-sm-4 control-label" style="text-align: end;">
                                Hình thức giao dịch
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-sm-6">
                                ...
                                <sec:authorize access="hasRole('ROLE_CONTENT_CATEGORY_ADD')">
                                    <a class="btn btn-sm btn-primary <%--pull-right--%>"
                                       ...
                                       data-target="#addOrEditModal" ng-click="addOrEdit('ADD', null)"><i
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tbl" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr ng-repeat="item in page.items track by $index">
                            ...
                            <td class="align-center">{{item.transactionName}}</td>
                            <td class="align-center">{{item.createdAt
