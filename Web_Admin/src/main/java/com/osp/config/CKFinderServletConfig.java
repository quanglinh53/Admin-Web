...
public class CKFinderServletConfig {
    ...
    public ServletRegistrationBean connectCKFinder(){
        ...
        registrationBean.addInitParameter("XMLConfig","classpath:/assets/ckfinder.xml");
        registrationBean.addInitParameter("debug","false");
        registrationBean.addInitParameter("configuration","com.osp.config.CKFinderConfig");
        //ckfinder.xml 
