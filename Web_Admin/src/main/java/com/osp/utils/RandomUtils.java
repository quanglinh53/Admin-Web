...
public class RandomUtils {
     ...
     * @return
     */
    public static long getRandomNumber(long min, long max) throws IllegalArgumentException {
     ...
     * @throws Exception
     */
    public static String getRandomPasswordNumber() throws IllegalArgumentException {
